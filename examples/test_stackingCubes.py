...
def main():
    ...
    env = gym.make(
        "gym_hil/PandaStackCubesBase-v0",  # Use the base environment for debugging
    ...
    env_id = "gym_hil/PandaStackCubesKeyboard-v0" if args.use_keyboard else "gym_hil/PandaStackCubesGamepad-v0"
    env = gym.make(
        env_id,
        render_mode=args.render_mode,
        image_obs=True,
